...
def arithmetic_arranger(problems):
  ...
  line1 = (str(library[0].get('line1'))+'  '+str(library[1].get('line1'))+'  '+str(library[2].get('line1')))
  line2 = (str(library[0].get('line2'))+'  '+str(library[1].get('line2'))+'  '+str(library[2].get('line2')))
  line3 = (str(library[0].get('line3'))+'  '+str(library[1].get('line3'))+'  '+str(library[2].get('line3')))
  line4 = (str(library[0].get('line4'))+'  '+str(library[1].get('line4'))+'  '+str(library[2].get('line4')))
